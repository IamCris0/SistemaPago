/* ============================================================
   ...
   ✅ Actualizado: incluye Prospectos en el menú
   ============================================================ */
...
const SidebarHTML = {
  render(activePage) {
    ...
    const nav = [
      {
        ...
        items: [
          ...
          { page: 'customers.html',   icon: 'customers', label: 'Clientes' },
          { page: 'prospects.html',   icon: 'prospects', label: 'Prospectos' },
    ...
    const icons = {
      ...
      customers: `<svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>`,
      prospects: `<svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="11" cy="11" r="8"/><path d="M21 21l-4.35-4.35"/><line x1="11" y1="8" x2="11" y2="14"/><line x1="8" y1="11" x2="14" y2="11"/></svg>`,
    ...
    const isProfile = activePage === 'profile.html';
      ...
      <aside class="sidebar" id="mainSidebar">
        ...
        <div class="sidebar-logo">
          <div class="sidebar-logo-mark">
            <img src="assets/img/logos.jpeg" alt="Logo"
              style="width:100%;height:100%;object-fit:contain;"
              onerror="this.outerHTML='<span style=font-weight:800;font-size:13px;color:#fff>SS</span>'"/>
          </div>
        ...
        <div class="sidebar-footer">
          <div class="user-card ${isProfile ? 'active' : ''}" id="profileBtn" title="Ver mi perfil" style="cursor:pointer;">
          ...
          <div style="padding:8px 16px 0;display:flex;gap:8px;">
            <button id="logoutBtn" title="Cerrar sesion"
              style="flex:1;padding:8px;background:rgba(239,68,68,0.1);color:#EF4444;border-radius:var(--radius-md);
